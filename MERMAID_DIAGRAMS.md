# AiBlogger 2.0 - Complete Mermaid Diagrams

This document contains all comprehensive flowcharts for the AiBlogger application.
...
3. [Create Blog with AI Flow](#3-create-blog-with-ai-flow)
4. [Comment Moderation Flow](#4-comment-moderation-flow)
5. [Authentication Flow](#5-authentication-flow)
6. [API Request Flow](#6-api-request-flow)
7. [Database Schema Structure](#7-database-schema-structure)
8. [Blog Listing & Display Flow](#8-blog-listing--display-flow)
9. [Image Upload & Optimization](#9-image-upload--optimization-flow)
10. [Gemini AI Content Generation](#10-gemini-ai-content-generation)

---

## 1. Complete User Flow

This diagram shows the complete journey of both visitors and admins through the application.
...
From homepage blog list to individual blog display.
...
Complete image processing workflow from upload to CDN.
...
### External Services
- **Google Gemini AI (gemini-2.0-flash)** - AI Content Generation
...
| GET | `/blogs` | ✅ | Get all blogs (including drafts) |
...
Simply push this file to your repository - Mermaid diagrams render automatically!

### Option 2: VS Code
1. You already have "Markdown Preview Mermaid Support" installed ✅
...
**Created for AiBlogger 2.0** - A modern, AI-powered blogging platform
